...
function start() {
    ...
    setInterval(function () { // DEPLACEMENT ==>
        started = 1;
        if ((direction == 0) && (parseInt(armee.style.top) <270)) {
            armee.style.left = parseInt(armee.style.left) + 1 + "px";
        }
        if (parseInt(armee.style.left) == 130) // DIRECTION BAS
        {
            direction = 1;

            if (parseInt(armee.style.top) < 300) {
    ...
    setInterval(function () { /* DEPLACEMENT <== */
        if ((direction == 1) && (parseInt(armee.style.top) < 270)) {
            armee.style.left = parseInt(armee.style.left) - 1 + "px";
        }
...
// lancementMissile = 0;
// var tailleMissile = document.getElementById("missile").offsetWidth;
// var tailleVaisseau = document.getElementById("vaisseau").offsetWidth;
...
//     if (event.key == " ") {
//         document.getElementById("missile").style.visibility = "visible";
//         if (lancementMissile === 1) {
//             return false;
//         }
//         var positionMissile = parseInt(vaisseau.style.left);
//         positionMissile += (document.getElementById("vaisseau").offsetWidth / 2);
//         positionMissile += (document.getElementById("missile").offsetWidth / 2);
